...
int8_t statusLed_pin = 13;

void setup(){
  pinMode(inputButton_pin,INPUT_PULLUP);
  pinMode(statusLed_pin,OUTPUT);digitalWrite(statusLed_pin,HIGH);delay(100);digitalWrite(statusLed_pin,LOW);delay(100);digitalWrite(statusLed_pin,HIGH);
